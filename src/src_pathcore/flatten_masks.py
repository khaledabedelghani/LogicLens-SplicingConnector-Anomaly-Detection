...
if __name__ == "__main__":
    ...
    logical_count = flatten_masks(
        project_root / "ground_truth" / "logical_anomalies",
        project_root / "ground_truth_flat" / "logical_anomalies",
    )

    structural_count = flatten_masks(
        project_root / "ground_truth" / "structural_anomalies",
        project_root / "ground_truth_flat" / "structural_anomalies",
    )
